...
// Разделённые методы: запрос и чтение ответа, вызываются в getAllWordsWithFrequency
...
// Разделённые методы: запрос и чтение ответа, вызываются в search
...
// Формирование индексов для ускорения поиска
